...
class SiElements:
    def __init__(self, namespace: str = SIURL + "SI#", prefix: str = "si"):
        ...
        self.g.add((self.Constant, RDFS.label, Literal("defining constant", lang="en")))
        self.g.add((self.Constant, RDFS.label, Literal("définir la constante", lang="fr")))
        self.g.add((self.Constant, RDFS.comment,
                    Literal("Class for the seven defining constants of the SI.", lang="en")))
        self.g.add((self.Constant, RDFS.comment,
                    Literal("La classe pour les sept constantes définissant le SI.", lang="fr")))
        ...
        self.g.add((self.MeasurementUnit, RDFS.label, Literal("measurement unit", lang="en")))
        ...
        self.g.add((self.SIBaseUnit, RDFS.label, Literal("base unit", lang="en")))
        self.g.add((self.SIBaseUnit, RDFS.label, Literal("unité de base", lang="fr")))
        self.g.add((self.SIBaseUnit, RDFS.isDefinedBy, Literal("VIM3 1.10")))
        self.g.add((self.SIBaseUnit, RDFS.comment,
                    Literal("""Class of SI base units. Several definitions can be attached to this
                               class to represent definitions of the BaseUnit throughout time.""", lang="en")))
        self.g.add((self.SIBaseUnit, RDFS.comment,
                    Literal("""La classe des unités de base SI. Plusieurs définitions peuvent être attachées à
                               cette clase pour représenter les définitions de l'unité de base en question
                               à travers les temps.""", lang="fr")))
        ...
        self.g.add((self.nonSIUnit, RDFS.label, Literal("non SI unit", lang="en")))
        self.g.add((self.nonSIUnit, RDFS.label, Literal("unité en dehors du SI", lang="fr")))
        ...
        self.g.add((self.Definition, RDFS.comment,
                    Literal("La classe pour les notes sur les définitions des unités SI.", lang="fr")))

        # Definition Note
        self.DefinitionNote = self.set_uri("DefinitionNote")
        self.g.add((self.DefinitionNote, RDF.type, SKOS.Concept))
        self.g.add((self.DefinitionNote, RDFS.label, Literal("unit definition note", lang="en")))
        self.g.add((self.DefinitionNote, RDFS.label, Literal("note de définition d'unité", lang="fr")))
        self.g.add((self.DefinitionNote, RDFS.comment,
                    Literal("The class for notes related SI unit definitions.", lang="en")))
        self.g.add((self.DefinitionNote, RDFS.comment,
                    Literal("La classe pour les définitions d'unités SI liées aux notes.", lang="fr")))

        # SIPrefix
        self.SIPrefix = self.set_uri("SIPrefix")
        self.g.add((self.SIPrefix, RDF.type, SKOS.Concept))
        self.g.add((self.SIPrefix, RDFS.label, Literal("SI prefix", lang="en")))
        self.g.add((self.SIPrefix, RDFS.label, Literal("préfixe SI", lang="fr")))
        self.g.add((self.SIPrefix, RDFS.comment, Literal("The class for SI Prefixes.", lang="en")))
        self.g.add((self.SIPrefix, RDFS.comment, Literal("La classe pour les préfixes SI.", lang="fr")))

        # Classes for Quantities
        self.QuantityKind = self.set_uri("QuantityKind")
        self.g.add((self.QuantityKind, RDF.type, SKOS.Concept))
        self.g.add((self.QuantityKind, RDFS.label, Literal("kind of quantity", lang="en")))
        self.g.add((self.QuantityKind, RDFS.label, Literal("nature de grandeur", lang="fr")))
        self.g.add((self.QuantityKind, RDFS.isDefinedBy, Literal("VIM3 1.2", datatype=XSD.string)))
        self.g.add((self.QuantityKind, RDFS.comment, Literal("Class for the quantity kinds.", lang="en")))
        self.g.add((self.QuantityKind, RDFS.comment, Literal("La classe pour les types de quantité.", lang="fr")))
        ...
        self.g.add((self.SIBaseUnit, OWL.disjointWith, self.SISpecialNamedUnit))
        ...
        self.g.add((self.hasSymbol, RDFS.label, Literal("has symbol", lang="en")))
        self.g.add((self.hasSymbol, RDFS.label, Literal("a un symbole", lang="fr")))
        self.g.add((self.hasSymbol, RDFS.range, XSD.string))
        self.g.add((self.hasSymbol, RDFS.comment,
                    Literal("Linking a measurement unit or prefix to a symbol.", lang="en")))
        self.g.add((self.hasSymbol, RDFS.comment,
                    Literal("Associer une unité de mesure ou un préfixe à un symbole.", lang="fr")))
        ...
        # self.g.add((self.hasUnit, RDFS.domain, self.MeasurementUnit))  # should this be domain? then below is true?
        ...
        self.g.add((self.hasUnit, RDFS.comment,
                    Literal("Linking a measurement unit to an SI base or specially named unit.", lang="en")))
        self.g.add((self.hasUnit, RDFS.comment,
        ...
        # hasValue
        self.hasValue = self.set_uri("hasValue")  # or hasNumericValue might be better
        self.g.add((self.hasValue, RDF.type, OWL.DatatypeProperty))
        self.g.add((self.hasValue, RDFS.label, Literal("has value", lang="en")))
        self.g.add((self.hasValue, RDFS.label, Literal("a de la valeur", lang="fr")))
        ...
        self.g.add((self.hasUnitPwr, RDFS.label, Literal("has unit power", lang="en")))
        self.g.add((self.hasUnitPwr, RDFS.label, Literal("a une puissance unitaire", lang="fr")))
        self.g.add((self.hasUnitPwr, RDFS.comment,
                    Literal("Derived units are defined as products of powers of the base units."
                            "An SI base unit has a power of 1 by definition.", lang="en")))
        self.g.add((self.hasUnitPwr, RDFS.comment,
                    Literal("Associer une unité de mesure à une base SI ou à une unité spécialement nommée."
                            "Une unité de base SI a une puissance de 1 par définition.", lang="fr")))
        ...
        self.g.add((self.hasUnitElement, RDFS.label, Literal("has unit element", lang="en")))
        self.g.add((self.hasUnitElement, RDFS.label, Literal("a un élément d'unité", lang="fr")))
        ...
        self.g.add((self.hasDefinition, RDFS.label, Literal("has definition", lang="en")))
        self.g.add((self.hasDefinition, RDFS.label, Literal("a une définition", lang="fr")))
        ...
        self.g.add((self.hasDefinition, RDFS.comment,
                    Literal("Linking an SI base unit to its definition.", lang="en")))
        self.g.add((self.hasDefinition, RDFS.comment,
                    Literal("Associer une unité de base SI à sa définition.", lang="fr")))

        # hasDefiningText
        self.hasDefiningText = self.set_uri("hasDefiningText")
        self.g.add((self.hasDefiningText, RDF.type, OWL.DatatypeProperty))
        self.g.add((self.hasDefiningText, RDFS.label, Literal("has defining text", lang="en")))
        self.g.add((self.hasDefiningText, RDFS.label, Literal("a un texte de définition", lang="fr")))
        ...
        self.g.add((self.hasDefiningText, RDFS.comment,
                    Literal("Linking an SI definition to the defining text.", lang="en")))
        self.g.add((self.hasDefiningText, RDFS.comment,
                    Literal("Associer une définition SI au texte de définition.", lang="fr")))

        # hasDefinitionNote
        self.hasDefinitionNote = self.set_uri("hasDefinitionNote")
        self.g.add((self.hasDefinitionNote, RDF.type, OWL.DatatypeProperty))
        self.g.add((self.hasDefinitionNote, RDFS.label, Literal("has definition note", lang="en")))
        self.g.add((self.hasDefinitionNote, RDFS.label, Literal("a une note de définition", lang="fr")))
        ...
        self.g.add((self.hasDefinitionNote, RDFS.comment,
                    Literal("Linking an SI definition to a definition note.", lang="en")))
        self.g.add((self.hasDefinitionNote, RDFS.comment,
                    Literal("Associer une définition SI à une note de définition.", lang="fr")))

        # hasNoteIndex
        self.hasNoteIndex = self.set_uri("hasNoteIndex")
        self.g.add((self.hasNoteIndex, RDF.type, OWL.DatatypeProperty))
        self.g.add((self.hasNoteIndex, RDFS.label, Literal("has note index", lang="en")))
        self.g.add((self.hasNoteIndex, RDFS.label, Literal("a un texte de note", lang="fr")))
        self.g.add((self.hasNoteIndex, RDFS.domain, self.DefinitionNote))
        self.g.add((self.hasNoteIndex, RDFS.range, RDFS.Literal))
        self.g.add((self.hasNoteIndex, RDFS.comment, Literal("The text of a definition note.", lang="en")))
        ...
        self.g.add((self.hasNoteText, RDFS.label, Literal("has note text", lang="en")))
        self.g.add((self.hasNoteText, RDFS.label, Literal("a un index de notes", lang="fr")))
        ...
        self.g.add((self.hasDefiningConstant, RDFS.label, Literal("has defining constant", lang="en")))
        self.g.add((self.hasDefiningConstant, RDFS.label, Literal("a une constante de définition", lang="fr")))
        ...
        self.g.add((self.hasDefiningConstant, RDFS.comment,
                    Literal("Linking a definition to its defining constant.", lang="en")))
        self.g.add((self.hasDefiningConstant, RDFS.comment,
                    Literal("Associer une définition à sa constante de définition.", lang="fr")))

        # hasNextDefinition
        self.hasNextDefinition = self.set_uri("hasNextDefinition")
        self.g.add((self.hasNextDefinition, RDF.type, OWL.ObjectProperty))
        self.g.add((self.hasNextDefinition, RDFS.label, Literal("has next definition", lang="en")))
        self.g.add((self.hasNextDefinition, RDFS.label, Literal("a la prochaine définition", lang="fr")))
        ...
        self.g.add((self.hasNextDefinition, RDFS.comment,
                    Literal("Linking an SI definition version to the next version.", lang="en")))
        self.g.add((self.hasNextDefinition, RDFS.comment,
                    Literal("Associer une version de définition SI à la version suivante.", lang="fr")))
        ...
        self.g.add((self.hasPreviousDefinition, RDFS.label, Literal("has previous definition", lang="en")))
        self.g.add((self.hasPreviousDefinition, RDFS.label, Literal("a la définition précédente", lang="fr")))
        ...
        self.g.add((self.hasPreviousDefinition, OWL.inverseOf, self.hasNextDefinition))
        self.g.add((self.hasNextDefinition, OWL.inverseOf, self.hasPreviousDefinition))
        self.g.add((self.hasPreviousDefinition, RDFS.comment,
                    Literal("Linking an SI definition version to the previous version.", lang="en")))
        self.g.add((self.hasPreviousDefinition, RDFS.comment,
                    Literal("Associer une version de définition SI à la version précédente.", lang="fr")))

        # hasStartValidity
        self.hasStartValidity = self.set_uri("hasStartValidity")
        self.g.add((self.hasStartValidity, RDF.type, OWL.DatatypeProperty))
        self.g.add((self.hasStartValidity, RDFS.label, Literal("has start validity", lang="en")))
        self.g.add((self.hasStartValidity, RDFS.label, Literal("a une validité de départ", lang="fr")))
        ...
        self.g.add((self.hasStartValidity, RDFS.comment,
                    Literal("Linking an SI definition to its starting validity date.", lang="en")))
        self.g.add((self.hasStartValidity, RDFS.comment,
                    Literal("Associer une définition SI à sa date de début de validité.", lang="fr")))
        ...
        self.g.add((restr_hasStartValidity, OWL.onProperty, self.hasStartValidity))
        self.g.add((restr_hasStartValidity, OWL.cardinality, Literal(1, datatype=XSD.int)))
        ...
        self.g.add((self.hasEndValidity, RDFS.label, Literal("has end validity", lang="en")))
        self.g.add((self.hasEndValidity, RDFS.label, Literal("a fin de validité", lang="fr")))
        ...
        self.g.add((self.hasEndValidity, RDFS.comment,
                    Literal("Linking an SI definition to its ending validity date.", lang="en")))
        self.g.add((self.hasEndValidity, RDFS.comment,
                    Literal("Associer une définition SI à sa date de fin de validité.", lang="fr")))
        ...
        self.g.add((self.hasDefiningEquation, RDFS.label, Literal("has defining equation", lang="en")))
        self.g.add((self.hasDefiningEquation, RDFS.label, Literal("a une équation de définition", lang="fr")))
        ...
        self.g.add((self.hasDefiningEquation, RDFS.comment,
                    Literal("Linking a SI definition to its defining equation.", lang="en")))
        self.g.add((self.hasDefiningEquation, RDFS.comment,
                    Literal("Associer une définition SI à son équation de définition.", lang="fr")))
        ...
        self.g.add((self.hasScalingFactor, RDFS.label, Literal("has scaling factor", lang="en")))
        self.g.add((self.hasScalingFactor, RDFS.label, Literal("a un facteur d'échelle", lang="fr")))
        ...
        self.g.add((self.hasScalingFactor, RDFS.comment,
                    Literal("Linking an SI prefix to its scaling factor.", lang="en")))
        self.g.add((self.hasScalingFactor, RDFS.comment,
                    Literal("Associer un préfixe SI à son facteur d'échelle.", lang="fr")))
        ...
        self.g.add((restr_hasScalingFactor, OWL.onProperty, self.hasScalingFactor))
        self.g.add((restr_hasScalingFactor, OWL.cardinality, Literal(1, datatype=XSD.int)))
        ...
        self.g.add((self.isDefiningResolutionOf, RDFS.comment,
                    Literal("Associer une résolution à la définition SI qu'elle a définie.", lang="fr")))

        # isUnitOfQtyKind
        self.isUnitOfQtyKind = self.set_uri("isUnitOfQtyKind")
        self.g.add((self.isUnitOfQtyKind, RDF.type, OWL.ObjectProperty))
        self.g.add((self.isUnitOfQtyKind, RDFS.label, Literal("is unit of quantity kind", lang="en")))
        self.g.add((self.isUnitOfQtyKind, RDFS.label, Literal("est une unité de quantité", lang="fr")))
        ...
        self.g.add((self.isUnitOfQtyKind, RDFS.comment,
                    Literal("Linking a measurement unit to its quantity kind.", lang="en")))
        self.g.add((self.isUnitOfQtyKind, RDFS.comment,
