...
* [si:MeasurementUnit](class-simeasurementunit.md)
    ...
    * si:CompoundUnit
        ...
        * [si:UnitMultiple](class-siunitmultiple.md) 
...
#### URI
http://si-digital-framework.org/SI#CompoundUnit
...
#### Instances of si:CompoundUnit can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="si:CompoundUnit" href="class-sicompoundunit.md" class="rdfclass">si:CompoundUnit</a></span>
            </th>
        </tr>       
