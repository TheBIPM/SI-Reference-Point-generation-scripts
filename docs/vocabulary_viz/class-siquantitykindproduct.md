...
#### URI
http://si-digital-framework.org/SI#QuantityKindProduct
...
#### Instances of si:QuantityKindProduct can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="si:QuantityKindProduct" href="class-siquantitykindproduct.md" class="rdfclass">si:QuantityKindProduct</a></span>
            </th>
        </tr>       
