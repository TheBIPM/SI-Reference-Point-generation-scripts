...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="si:Constant" href="class-siconstant.md" class="rdfclass">si:Constant</a></span>
            </th>
        </tr>       
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasUnitAsString" href="prop-sihasunitasstring.md">si:hasUnitAsString</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasUnitAsString*>></span>
                </td>
                <td class="secondtd">
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasUpdatedDate" href="prop-sihasupdateddate.md">si:hasUpdatedDate</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasUpdatedDate*>></span>
                </td>
                <td class="secondtd">
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasValue" href="prop-sihasvalue.md">si:hasValue</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasValue*>></span>
                </td>
                <td class="secondtd">
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasValueAsString" href="prop-sihasvalueasstring.md">si:hasValueAsString</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasValueAsString*>></span>
                </td>
                <td class="secondtd">
