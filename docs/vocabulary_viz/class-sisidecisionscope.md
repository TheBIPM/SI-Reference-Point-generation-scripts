...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="si:SIDecisionScope" href="class-sisidecisionscope.md" class="rdfclass">si:SIDecisionScope</a></span>
            </th>
        </tr>       
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasTarget" href="prop-sihastarget.md">si:hasTarget</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasTarget*>></span>
                </td>
                <td class="secondtd">
