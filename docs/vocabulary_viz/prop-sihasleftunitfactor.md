...
#### URI
http://si-digital-framework.org/SI#hasLeftUnitFactor
...
#### Usage
owl:Thing=&gt;&nbsp;_si:hasLeftUnitFactor_&nbsp;=&gt;&nbsp;owl:Thing
...
si:hasLeftUnitFactor a owl:ObjectProperty ;
    rdfs:label "has left unit factor" ;
