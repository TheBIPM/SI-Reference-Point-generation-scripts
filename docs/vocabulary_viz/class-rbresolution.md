...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="rb:Resolution" href="class-rbresolution.md" class="rdfclass">rb:Resolution</a></span>
            </th>
        </tr>       
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:isDefiningResolutionOf" href="prop-siisdefiningresolutionof.md">si:isDefiningResolutionOf</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#isDefiningResolutionOf*>></span>
                </td>
                <td class="secondtd">
