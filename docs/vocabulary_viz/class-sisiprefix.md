...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="si:SIPrefix" href="class-sisiprefix.md" class="rdfclass">si:SIPrefix</a></span>
            </th>
        </tr>       
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="si:hasScalingFactor" href="prop-sihasscalingfactor.md">si:hasScalingFactor</a>         
                </td>
                <td class="thirdtd">
                    <span><bound method RdfEntity.bestDescription of <Property *http://si-digital-framework.org/SI#hasScalingFactor*>></span>
                </td>
                <td class="secondtd">
